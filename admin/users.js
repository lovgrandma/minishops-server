...
const createSingleShopAndAttachToAccount = () => {
    return "create (a:Shop { name: $name, ledger: [], authorized: true, publishDate: $publishDate, description: $description, icon: $icon, shippingClasses: [], origins: [] }) with a match (b:Person {name: $name }) with a, b merge (b)-[r:OWNS]-(a) return a, r, b";
}